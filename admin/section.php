            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="section.php" class="nav__link  active">
                            <i class='bx bx-user-voice' ></i>
                ...
                <div class="container clsmm" style="margin-bottom: 20px;">
                    <div class="row teach">
                        ...
                        <form action="section.php" method="post">
                            Sec ID: <input style="margin-bottom: 10px;" type="text" name="id" placeholder="Enter Course Number.."><br>
                            Semester ID: <input style="margin-bottom: 10px;" type="text" name="name" placeholder="Enter Course Number.."><br>
                            Course ID: <input style="margin-bottom: 10px;" type="text" name="address" placeholder="Enter Course Number.."><br>
                            Teacher ID: <input style="margin-bottom: 10px;" type="text" name="phone" placeholder="Enter Course Number.."><br>
                            Time: <input style="margin-bottom: 10px;" type="text" name="tt" placeholder="Enter Course Number.."><br>
                            <input type="submit" name="isns" value="Enter">
                        </form>
                        <?php 
                           if(!empty($_POST['id']) && !empty($_POST['name']) && !empty($_POST['address']) && !empty($_POST['phone'])){
                            $q="insert INTO `section`(`sec_id`, `sem_id`, `course_id`, `te_id`, `time`) 
                            VALUES ('".$_POST['id']."','".$_POST['name']."','".$_POST['address']."','".$_POST['phone']."','".$_POST['tt']."')";
                        ...
                        <div class="col-12 col-md-4 col-lg-4">
                            ...
                            <hr>
                        <form action="section.php" method="post">
                            Section ID: <input style="margin-bottom: 10px;" type="text" name="idr" placeholder="Enter id Number.."><br>
                            <input type="submit" name="search" value="Enter">
                        </form>
                        <?php 
                           if(!empty($_POST['idr'])){
                            $q="delete FROM `section` 
                                WHERE sec_id = '".$_POST['idr']."' and sem_id = '".$sem."'";
