            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="semar.php" class="nav__link active">
                            <i class='bx bx-user-check' ></i>
        ...
        <div class="body-main">
            <div class="container-fluid">
                <div class="container teach">
                    <h1 class="h22">Semester Add/ Rem / Update</h1>
                    <hr>
                </div>
            </div>
            <div class="container-fluid">
                <div class="container clsmm" style="margin-bottom: 20px;">
                    <div class="row teach">
                        <div class="col-12 col-md-4 col-lg-4">
                            <h3>Addition</h3>
                            <hr>
                        <form action="semar.php" method="post">
                            Semester ID: <input style="margin-bottom: 10px;" type="text" name="sem_id" placeholder="Enter Course Number.."><br>
                            Semester Name: <input style="margin-bottom: 10px;" type="text" name="sem_name" placeholder="Enter Course Number.."><br>
                            <input type="submit" name="enta" value="Enter">
                        </form>
                        <?php 
                           if(!empty($_POST['sem_id']) && !empty($_POST['sem_name'])){
                            $q="insert into `sem`(`id`, `name`) 
                                values ('".$_POST['sem_id']."','".$_POST['sem_name']."')";
                        ...
                        <div class="col-12 col-md-4 col-lg-4">
                            ...
                            <hr>
                        <form action="semar.php" method="post">
                            Semester ID: <input style="margin-bottom: 10px;" type="text" name="sem_idr" placeholder="Enter Course Number.."><br>
                            <input type="submit" name="enta2" value="Enter">
                        </form>
                        <?php 
                           if(!empty($_POST['sem_idr'])){
                            $q="delete from `sem` 
                                where id = '".$_POST['sem_idr']."'";
