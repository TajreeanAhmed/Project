            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="teacheraru.php" class="nav__link  active">
                            <i class='bx bx-book-reader' ></i>
        ...
        <div class="body-main">
            <div class="container-fluid">
                <div class="container teach">
                    <h1 class="h22">Teacher Add/ Rem / Update</h1>
                    <hr>
                </div>
            </div>
            <div class="container-fluid">
                <div class="container clsmm" style="margin-bottom: 20px;">
                    <div class="row teach">
                        <div class="col-12 col-md-4 col-lg-4">
                            <h3>Addition</h3>
                            <hr>
                        <form action="teacheraru.php" method="post">
                        ...
                        <?php 
                           if(!empty($_POST['id']) && !empty($_POST['name']) && !empty($_POST['address']) && !empty($_POST['phone']) && !empty($_POST['email']) && !empty($_POST['semester']) && !empty($_POST['depa'])){
                            $q="insert INTO `teacher`(`id`, `name`, `address`, `phone`, `email`, `sem`, `dep_id`) 
