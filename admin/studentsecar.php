            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="studentsecar.php" class="nav__link active">
                            <i class='bx bx-user-check' ></i>
                ...
                <div class="container clsmm" style="margin-bottom: 20px;">
                    <div class="row teach">
                        <div class="col-12 col-md-4 col-lg-4">
                            <h3>Addition</h3>
                            <hr>
                        <form action="studentsecar.php" method="post">
                            Semester ID: <input style="margin-bottom: 10px;" type="text" name="id" placeholder="Enter Course Number.."><br>
                            Student ID: <input style="margin-bottom: 10px;" type="text" name="name" placeholder="Enter Course Number.."><br>
                            Section ID: <input style="margin-bottom: 10px;" type="text" name="address" placeholder="Enter Course Number.."><br>
                            <input type="submit" name="isns" value="Enter">
                        </form>
                        <?php 
                           if(!empty($_POST['id']) && !empty($_POST['name']) && !empty($_POST['address'])){
                            $q="insert INTO `studentsec`(`sem_id`, `st_id`, `sec_id`) 
                        ...
                        <div class="col-12 col-md-4 col-lg-4">
                            ...
                            <hr>
                        <form action="studentsecar.php" method="post">
                            Student ID: <input style="margin-bottom: 10px;" type="text" name="idr" placeholder="Enter id Number.."><br>
                            Section ID: <input style="margin-bottom: 10px;" type="text" name="idr2" placeholder="Enter id Number.."><br>
                            <input type="submit" name="search" value="Enter">
                        </form>
                        <?php 
                           if(!empty($_POST['idr'])){
                            $q="delete FROM `studentsec` 
                                WHERE st_id = '".$_POST['idr']."' and sem_id = '".$sem."' and sec_id = '".$_POST['idr2']."'";
