            ...
            <div class="container clsmm" style="margin-bottom: 20px;">
                    <div class="row teach">
                        ...
                        <form action="notice.php" method="post">
                            Notice Tittle: <input style="margin-bottom: 10px;" type="text" name="tt" placeholder="Enter Course Number.."><br>
                            Notice Text: <textarea name="txt" id="" cols="35" rows="7"></textarea>
                            <br>
                            <input type="submit" name="search" value="Enter">
                        </form>
                        <?php
                           if(!empty($_POST['tt']) && !empty($_POST['txt'])){
                            $q="insert INTO `notice`(`tittle`, `ntext`)
                            VALUES ('".$_POST['tt']."','".$_POST['txt']."')";
