            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="studgrade.php" class="nav__link  active">
            ...
            <div class="container-fluid classf">
                <div class="container teach">
                    ...
                    <div class="row">
                        ...
                        $qm="select count(g.grade) as c_grade
                             from grade g, course c, department d
                             where d.id = c.dep_id and c.id = g.course_id and g.st_id = '".$_POST['stud_id']."'";
                        ...
                        ?>
                        <h4>There Is No Grade To Show!!<br>**Enter Valid Student ID**</h4>
                        <?php
                        }
                        }else{
                        ?>
                        <h4>Enter Student ID .. (Example: 18311)</h4>
                        <?php
                        }
                        ?>
                    </div>
