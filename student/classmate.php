            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="classmate.php" class="nav__link active">
        ...
        <div class="body-main">
            <div class="container-fluid">
                <div class="container clsmm" style="margin-bottom: 20px;">
                    <div class="row">
                        <form action="classmate.php" method="post">
            ...
            <div class="container-fluid classf">
                <div class="container teach">
                    <h1 class="h22">Classmates</h1>
                    <hr>
                    <div class="row">
                        <?php
                        if(!empty($_POST['search'])){
                        $qm="select COUNT(st.id) as s_count
                        from section s, studentsec sc, student st
                        where st.id = sc.st_id and sc.sec_id = s.id and s.sem_id = '".$sem."' and sc.st_id != '".$_SESSION['userid']."' and s.sec_id = '".$_POST['sec_id']."' and s.sec_id in (select s.sec_id
                        ...
                        if($scount > 0){
                        $q="select st.name, d.name as dep_name, st.email
                        from section s, studentsec sc, student st, department d
                        where st.dep_id = d.id and st.id = sc.st_id and sc.sec_id = s.id and s.sem_id = '".$sem."' and sc.st_id != '".$_SESSION['userid']."' and s.sec_id = '".$_POST['sec_id']."' and s.sec_id in (select s.sec_id
                        from section s, studentsec sc
                        where s.id = sc.sec_id and sc.st_id = '".$_SESSION['userid']."' and sc.sem_id = '".$sem."')";
                        ...
                        ?>
                        <h4>You Are Not In This Section!!</h4><br>
                        <h4>**Enter Valid Section**</h4>
                        <?php
                        }
                        }else{
                        ?>
                        <h4>Enter Your Section Number In This Semester .. (Example: 3)</h4>
                        <?php
                        }
                        ?>
                    </div>
